...
/***/ function(module, exports, __webpack_require__) {
	...
	var TONES = __webpack_require__(2);
	var KeyListener = __webpack_require__(3);
	var React = __webpack_require__(28);
	var ReactDOM = __webpack_require__(182);
	var Key = __webpack_require__(183);
	var Organ = __webpack_require__(184);
...
/***/ function(module, exports) {
	...
	module.exports = { TONES: TONES, MAPPINGS: MAPPINGS };
		...
		render: function () {
			var keys = alpha.map(function (letter, idx) {
				return React.createElement(
					"li",
					{ key: idx },
					React.createElement(Key, { note: letter })
				);
			});
